...
namespace TestCase241.Pages
{
    ...
    [Scaffold(typeof(UraniumUI.Material.Controls.RadioButtonGroupView), baseTypeNamespace: "UraniumIntApp.Controls.InputKitSharedLayouts")]
    public partial class UraniumRadioButtonGroupView { }


    [Scaffold(typeof(UraniumUI.Material.Controls.RadioButton), baseTypeNamespace: "UraniumIntApp.Controls.InputKitSharedLayouts")]
    ...
    public partial class TabItem<T> : IEnumerable
    {
        ...
        {
            if (childNativeControl is MauiControls.View view)
            {
